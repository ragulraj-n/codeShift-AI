...
const CreateProjectModal = ({ isOpen, onClose, defaultFolderId = null }) => {
  ...
  }, [isOpen, dispatch, defaultFolderId]);
  ...
  const handleSubmit = async (e) => {
    ...
    const defaultSourceCode = `// Enter your code here
function greet(name) {
    console.log("Hello, " + name + "!");
}

greet("World");`;
    const defaultSourceLang = 'javascript';
